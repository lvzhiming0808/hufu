...
export default {
  ...
  [types.SETDATELINE](state, value) {    // 操作日期
    state.dateline = value
  },
  [types.SETRECORDSCORE](state, value) {    // 分值
    state.recordScore = value
  },
  // 切换我的全部
  ...
  [types.SETISVIOLATION](state, value) {
    state.isViolation = value
  }
}
